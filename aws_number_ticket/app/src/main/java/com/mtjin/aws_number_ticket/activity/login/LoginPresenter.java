            ...
            public void onResponse(Call<User> call, Response<User> response) {
                ...
                if(response.isSuccessful() && response.body() != null){
                    ...
                    if(isSuccess){
                        ...
                        view.successLogin(response.body().getId(), response.body().getUserId(), response.body().getUserRestaurant(), response.body().getRestaurantLocation(), response.body().getRestaurantTel() );
                    }else{
